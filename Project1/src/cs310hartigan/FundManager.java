 ...
 * attributes to keep track of a broker's license number, first name, last name, 
 ...
 * broker license or department number are valid.
 * 
...
public class FundManager {
   ...
   // Constructors
    ...
    // Methods to check validity of broker license number and department number

    /**
     * checkBrokerLicenseIsValid
     * Takes a broker license number as String  input.  Checks to make sure the input
    ...
    /**
     * checkDeptIsValid
     * Takes a broker department number as String  input.  Checks to make sure
     ...
     * @return boolean
     */
    public boolean checkDeptIsValid(String dept) {
