 ...
 * number of whole shares, broker's license number and whether or not it is taxable.
...
public class StockTrade {
    ...
    // Methods to check validity of stock symbol, price per share and number of shares

    /**
     * checkStockSymbolIsValid
     * Takes a stock symbol as String input.  Checks to make sure the input 
     ...
     * @return boolean
     */
    public boolean checkStockSymbolIsValid(String stockSymbol) {
     ...
     * Takes a stock price as double input.  Checks to make sure it is less than
     * the MAX_SHARE_PRICE
     * 
     * 
     * @param pricePerShare
     * @return boolean
     */
    public boolean checkPricePerShareIsValid(double pricePerShare) {
     ...
     * @return boolean
     */
    public boolean checkWholeSharesIsValid(int wholeShares) {
