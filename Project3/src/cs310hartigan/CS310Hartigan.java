 ...
 * For Week 3 of CS310, it features seven methods (main, 
 ...
 * will instantiate a single Linked List data structure for the FundManager object
 * class, as well as a LinkedList<> data structure for the StockTrade object class.
 * A print implementation class will also be instantiated and used to
 * generate an output reports.
 * 
...
public class CS310Hartigan {
    ...
    * program.  Once the initial input processing is complete, main calls
    * createReport to generate an initial output report.  Upon completion, main
    * calls the cleanUp() methods from both the FundManager and StockTrade
    * classes to remove any elements with invalid broker license numbers or 
    * stock symbols.  Method createReport() is then called once more to generate
    * a clean output file.
    * 
    * @param args the command line arguments
    */
   public static void main(String[] args) {
       final String INPUT_FILENAME = "input/assn3input20.txt"; 
       final String INITIAL_OUTPUT_FILENAME = "output/assn3initialReport.txt";
       final String CLEAN_OUTPUT_FILENAME = "output/assn3cleanReport.txt";
       ...
       // Create initial output report
       System.out.println("Creating initial report...");
       System.out.println();
       createReport(INITIAL_OUTPUT_FILENAME);
