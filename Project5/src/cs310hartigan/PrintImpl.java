        ...
        try {
           ...
           // Open output file
            ...
            while (inputFileScanner.hasNextLine()) {
                ...
                if (fundManagerLogImpl.find(inputLineParsed[0]) == null) {
                ...
                // Once FM is verified, write their name to the output file along with ST status
                    ...
                    outputFileObject.println("FundManager " + inputLineParsed[0] + ", " + fundManagerLogImpl.find(inputLineParsed[0]).getFirstName() + " " + fundManagerLogImpl.find(inputLineParsed[0]).getLastName());
